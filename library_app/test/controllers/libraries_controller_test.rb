...
class LibrariesControllerTest < ActionController::TestCase
  ...
  test "should create library" do
    assert_difference('Library.count') do
      post :create, library: { author: @library.author, notes: @library.notes, read: @library.read, title: @library.title }
    end
  ...
  test "should update library" do
    patch :update, id: @library, library: { author: @library.author, notes: @library.notes, read: @library.read, title: @library.title }
    assert_redirected_to library_path(assigns(:library))
  end
